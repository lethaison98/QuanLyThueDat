        ...
        public async Task<ApiResult<byte[]>> ExportThongBaoTienThueDatHangNam(int namThongBao)
        {
            ...
            if (ws != null)
            {
                ...
                foreach (var obj in data)
                {
                    ...
                    ws.Cells[6 + i, 11].Value = decimal.Parse(obj.SoTien, new CultureInfo("vi-VN"));
                    ws.Cells[6 + i, 12].Value = decimal.Parse(obj.SoTienMienGiam, new CultureInfo("vi-VN"));
                    ws.Cells[6 + i, 13].Value = decimal.Parse(obj.SoTienPhaiNop, new CultureInfo("vi-VN"));
                    ws.Cells[6 + i, 14].Value = obj.GhiChu;
                ...
                ws.Cells[7, 1, i + 7, 14].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
                ws.Cells[7, 10, i + 7, 14].Style.Numberformat.Format = "#,##0.00";
