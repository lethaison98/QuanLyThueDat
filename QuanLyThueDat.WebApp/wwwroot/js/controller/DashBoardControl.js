...
DashBoardControl = {
    ...
    LoadDatatableHopDongThueDat: function (opts) {
        var self = this;
        self.table = SetDataTable({
            table: $('#tblHopDongSapHetHan'),
            url: localStorage.getItem("API_URL") + "/HopDongThueDat/CanhBaoHopDongSapHetHan",
            dom: "t",
            data: {
                //"requestData": function () {
                //    return {
    ...
    RegisterEvents: function () {
        ...
        self.LoadDatatableHopDongThueDat();
        setTimeout(() => {
